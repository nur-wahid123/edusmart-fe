  ...
  return (
    <div className="">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <Label htmlFor="teachers_limit">Violation Type Limit</Label>
          <Input
            id="teachers_limit"
            name="teachers_limit"
            type="text"
            value={school.teachers_limit ?? ""}
            onChange={handleChange}
            min={0}
          />
        </div>
        <div>
          <Label htmlFor="questions_limit">Violation Limit</Label>
          <Input
            id="questions_limit"
            name="questions_limit"
            type="text"
            value={school.questions_limit ?? ""}
            onChange={handleChange}
            min={0}
          />
        </div>
        <div>
          <Label htmlFor="question_packs_limit">Classes Limit</Label>
          <Input
            id="question_packs_limit"
            name="question_packs_limit"
            type="text"
            value={school.question_packs_limit ?? ""}
            onChange={handleChange}
            min={0}
          />
        </div>
