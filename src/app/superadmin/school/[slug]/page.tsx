...
export default function SchoolDetailPage() {
  ...
  const stats = [
    ...
    },
    {
      label: "Pertanyaan",
      value: school.users
        ? school.users.filter((u) => u.user_type === RoleEnum.SCHOOL_ADMIN).length
        : 0,
      icon: <UserCog className="w-4 h-4 text-purple-500" />,
      limit: school.questions_limit,
    ...
    },
    {
      ...
      limit: school.question_packs_limit,
                ...
                <div className="flex flex-col gap-1 text-sm min-w-[120px]">
                  ...
                  <div>
                    ...
                    <Badge variant="secondary">
                      {user.user_type &&
                      RoleEnum[user.user_type as unknown as keyof typeof RoleEnum]
                        ? RoleEnum[
                            user.user_type as unknown as keyof typeof RoleEnum
                          ]
                        : user.user_type || <span className="italic">-</span>}
                    </Badge>
                  </div>
                  <div>
