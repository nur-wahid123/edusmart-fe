        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            <div className="flex flex-col gap-6">
              ...
              <div>
                <Label htmlFor="teachers_limit">Guru Maks</Label>
                <Input
                  id="teachers_limit"
                  name="teachers_limit"
                  type="number"
                  min={1}
                  value={form.teachers_limit}
                  onChange={handleChange}
                  className="mt-1"
                />
              </div>
              <div>
                <Label htmlFor="question_packs_limit">Kelompok Pertanyaan Maks</Label>
                <Input
                  id="question_packs_limit"
                  name="question_packs_limit"
                  type="number"
                  min={1}
                  value={form.question_packs_limit}
                  onChange={handleChange}
                  className="mt-1"
                />
              </div>
              <div>
                <Label htmlFor="questions_limit">Pertanyaan Maks</Label>
                <Input
                  id="questions_limit"
                  name="questions_limit"
                  type="number"
                  min={1}
                  value={form.questions_limit}
                  onChange={handleChange}
                  className="mt-1"
                />
              </div>
